        ...
        <div class="col">
          ...
          <div class="register-account__process">
            ...
            <div class="form-group">
              <input type="text" name="name" value="<?= set_value('name'); ?>" class="form-control <?= form_error('name') ? 'is-invalid' : ''; ?> form-control-user" placeholder="Masukan Nama Kamu" autofocus>
            ...
            <div class="form-group">
              <input type="password" name="password2" class="form-control <?= form_error('password2') ? 'is-invalid' : ''; ?> form-control-user" placeholder="Konfirmasi password">
